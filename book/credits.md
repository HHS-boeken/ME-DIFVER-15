...
Raoul Tjokrojoso van de Haagse Hogeschool (2025) _ME-DIFVER-15 - Differentiaal vergelijkingen_. [https://hhs-boeken.github.io/ME-DIFVER-15](https://hhs-boeken.github.io/ME-DIFVER-15/2526). Bronbestanden op {octicon}`mark-github` [HHS-boeken/ME-DIFVER-15](https://github.com/HHS-boeken/ME-DIFVER-15). CC BY 4.0.

Je kunt naar individuele hoofdstukken of pagina's binnen dit boek verwijzen als:

`<Titel van Hoofdstuk of Pagina>`. in Raoul Tjokrojoso van de Haagse Hogeschool (2025) _ME-DIFVER-15 - Differentiaal vergelijkingen_. `<url naar specifieke pagina op de boekwebsite>`. Bronbestanden op `<link naar specifieke commit / bestand in github repo>`. CC BY 4.0.
...
Deze website is geschreven in markdown- en jupyternotebook-bestanden, die worden omgezet naar html met behulp van tools van [TeachBooks](https://teachbooks.io/). De bestanden zijn opgeslagen in een [publieke GitHub-repository](https://github.com/HHS-boeken/ME-DIFVER-15). De website is te bekijken op [https://hhs-boeken.github.io/ME-DIFVER-15](https://hhs-boeken.github.io/ME-DIFVER-15/2526).
